...
# Modified: updated import of utils to package-relative; replaced U+203E with "_".
import math
import random
...
class Tree:
    ...
    BRANCH_COLOUR = ((200, 255), (150, 255), (0, 0))
    ...
    def draw_box_feet(self, root_inx1, root_inx2):
        ...
        for sign in range(-1, 2, 2):
            ...
            # replaced U+203E overline with plain underscore for Windows cp1252 compat
            self.window.set_char_instant(inx1, inx2, "_", Tree.BOX_COLOUR, True)
